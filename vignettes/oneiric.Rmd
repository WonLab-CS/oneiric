...
circle <- simulate_spatial(n_cells = 1000,
    n_territories = 5,
    n_samples = 12,
    pattern = "circle",
    expanse = c(0.1, 0.3))

rod <- simulate_spatial(n_cells = 1000,
    n_territories = 5,
    n_samples = 12,
    pattern = "rod",
...
chaos_map <- simulate_spatial(n_cells = 1000,
    n_samples = 12,
    pattern = "chaos",
    expanse = 0.02) 

random_map <- simulate_spatial(n_cells = 1000,
    n_territories = 5,
    n_samples = 12,
    pattern = "random",
    width_range = c(0.0, 0.1),
...
circular <- simulate_spatial(n_cells = 1000, 
    n_territories = 5, 
    n_samples = 12, 
    pattern = "circle", 
    expanse = c(0.1, 0.25), 
...
Adding layers to your territories. Each territory will have a different cell type composition.
However, the difference will be lower than between territories (defined by `de_layer`). 

```{r circle_layer_nl, eval = TRUE, echo = TRUE}
circular_layer_nl <- simulate_spatial(n_cells = 1000,
    n_territories = 1,
    n_samples = 12,
    pattern = "circle",
    expanse = c(0.4, 0.5),
...
## Simuating dropped cells

```{r circle_layer_rnd, eval = TRUE, echo = TRUE}
circular_layer_rnd <- simulate_spatial(n_cells = 1000,
    n_territories = 2,
    n_samples = 12,
    pattern = "circle",
    expanse = c(0.15, 0.3),
